...
#ifndef CHROMIUM_WIN_EVENT_TRACE_PROVIDER_HH_
#define CHROMIUM_WIN_EVENT_TRACE_PROVIDER_HH_
#pragma once
...
template <size_t N> class EtwMofEvent: public EtwMofEventBase<N>, boost::noncopyable {
 public:
...
// messages themselves.
class EtwTraceProvider : boost::noncopyable {
 public:
...
#endif  // CHROMIUM_WIN_EVENT_TRACE_PROVIDER_HH_
