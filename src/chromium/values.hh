...
class DictionaryValue : public Value
{
 public:
  ...
  // be used as paths.
  bool GetWithoutPathExpansion(const std::string& key, Value** out_value) const;
  ...
  bool GetDictionaryWithoutPathExpansion(const std::string& key, DictionaryValue** out_value) const;
  bool GetListWithoutPathExpansion(const std::string& key, ListValue** out_value) const;
